...
// wire-format-typer + kotpass-mapper. Tests kører på almindelig JVM, så vi
// behøver ikke emulator for at validere mod Go-emitterede fixtures.
...
dependencies {
    // Eksponér de tunge dependencies som `api` — :app-modulet (Android)
    // bruger samme kotpass-typer og OkHttp-klient direkte, og uden api()
    // ville Gradle's resolution-model holde dem ude af :app's classpath.
    api("org.jetbrains.kotlinx:kotlinx-serialization-json:1.7.3")
    api("org.jetbrains.kotlinx:kotlinx-datetime:0.6.1")
    api("app.keemobile:kotpass:0.13.0")
